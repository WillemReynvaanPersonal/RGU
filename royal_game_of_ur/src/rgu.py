...
class RGU(object):
    ...
    def __init__(self):
        ...
        '''
        self.board_values = np.asarray([[[ 2.12899862, -1.94372679,  4.61896157, -0.71309179,  2.9088326,  2.88175053, -0.59207986,  1.10690222],
                              [ 2.48175842,  0.56767907, -0.09414909,  1.71107248, -0.71730299,  2.24665514, 0.88095251, -1.01279484],
                              [ 0.77165301, -0.70838524,  1.18265237,  1.7804434,  -0.94315697, -0.16866618, -0.33109534, -1.6874568 ]],
                            
                             [[ 2.02899862, -1.84372679,  4.81896157, -0.81309179,  3.1088326,   2.68175053, -0.69207986,  1.10690222],
                              [ 2.58175842,  0.56767907, -0.09414909,  1.71107248, -0.71730299,  2.14665514, 0.98095251, -1.01279484],
                              [ 0.57165301, -0.80838524,  1.08265237,  1.7804434,  -0.94315697, -0.06866618, -0.43109534, -1.6874568 ]]])
    
        '''
        self.board_values = np.asarray([[[ 0.9,  0.6,  0.4,  0.8,  0.1,  1.,   0.7,  0.8],
    ...
    def do_move(self, s, r):
        ...
        if s+r in self.vulnerable_idx and \
